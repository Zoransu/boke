...
public interface UserMapper {
    ...
    @Insert("INSERT INTO user (user_name, user_password, user_email, registration_date, user_telephone_number, user_nickname) " +
            "VALUES (#{userName}, #{userPassword}, #{userEmail}, #{registrationDate}, #{userTelephoneNumber}, #{userNickname})")
